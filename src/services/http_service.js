...
function http(Dom7) {
  ...
  function get (url, query, opts) { return httpRequest('GET', url, query, opts); }
  function post(url, data, opts) { return httpRequest('POST', url, data, opts); }
  function put(url, data, opts) { return httpRequest('PUT', url, data, opts); }
  function del(url, data, opts) { return httpRequest('DELETE', url, data, opts); }
